                    ...
                    <div className="products__content grid">
                        ...
                        <article className="products__card delicacies">
                            <div className="products__shape">
                                <img src="src/img/delicacies1.png" alt="" className="products__img" />
                            </div>
                        ...
                        <article className="products__card delicacies">
                            <div className="products__shape">
                                <img src="src/img/delicacies2.png" alt="" className="products__img" />
                            </div>
                            <div className="products__data">
                        ...
                        <article className="products__card delicacies">
                            <div className="products__shape">
                                <img src="src/img/delicacies3.png" alt="" className="products__img" />
                            </div>
                            <div className="products__data">
                        ...
                        <article className="products__card coffee">
                            <div className="products__shape">
                                <img src="src/img/coffee1.png" alt="" className="products__img" />
                            </div>
                            <div className="products__data">
                                <h2 className="products__price"> $2 </h2>
                                <h3 className="products__name">Medialuna</h3>
                        ...
                        <article className="products__card coffee">
                            <div className="products__shape">
                                <img src="src/img/coffee2.png" alt="" className="products__img" />
                            </div>
                            <div className="products__data">
                                <h2 className="products__price"> $6 </h2>
                                <h3 className="products__name">Croissant</h3>
                        ...
                        <article className="products__card coffee">
                            <div className="products__shape">
                                <img src="src/img/coffee3.png" alt="" className="products__img" />
                            </div>
                            <div className="products__data">
                                <h2 className="products__price"> $10 </h2>
                                <h3 className="products__name">Sanguchitos</h3>
                        ...
                        <article className="products__card coffee">
                            <div className="products__shape">
                                <img src="src/img/coffee4.png" alt="" className="products__img" />
                            </div>
                            <div className="products__data">
                                <h2 className="products__price"> $2 </h2>
                                <h3 className="products__name">Medialuna</h3>
                        ...
                        <article className="products__card cake">
                            <div className="products__shape">
                                <img src="src/img/cake1.png" alt="" className="products__img" />
                            </div>
                            <div className="products__data">
                        ...
                        <article className="products__card cake">
                            <div className="products__shape">
                                <img src="src/img/cake2.png" alt="" className="products__img" />
                            </div>
                            <div className="products__data">
                        ...
                        <article className="products__card cake">
                            <div className="products__shape">
                                <img src="src/img/cake3.png" alt="" className="products__img" />
                            </div>
                            <div className="products__data">
                                <h2 className="products__price"> $10 </h2>
                        ...
                        <article className="products__card cake">
                            <div className="products__shape">
                                <img src="src/img/cake4.png" alt="" className="products__img" />
                            </div>
                            <div className="products__data">
                                <h2 className="products__price"> $15 </h2>
                                <h3 className="products__name">Torta ricota</h3>
